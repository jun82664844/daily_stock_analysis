...
OK_MARKER = "DSA_PLATFORM_A_STOCK_DATA_DETAILS_V64_OK"
...
REQUIRED_MARKERS: dict[str, list[str]] = {
    ...
    "api/v1/schemas/basic_query.py": [
        "details: List[BasicAShareReaderFactPayload]",
    ],
    "tests/test_a_share_enrichment_service.py": [
        "test_a_stock_data_channels_include_v64_structured_details",
        "主力净额",
        "净买入",
    ],
    "tests/test_basic_query_no_ai.py": [
        "Preserved through response schema.",
        '"details"',
    ],
    ...
    "apps/dsa-web/src/pages/HomePage.tsx": [
        "a-share-channel-details",
        "item.details",
    ],
    "apps/dsa-web/src/pages/__tests__/HomePage.test.tsx": [
        "renders V64 structured A-share channel details in Chinese mode",
        "主力净额",
        "最新分钟",
    ],
    ".gitignore": [
...
def main() -> int:
    ...
    if failed:
        print("DSA_PLATFORM_A_STOCK_DATA_DETAILS_V64_FAILED")
        return 1
    print(OK_MARKER)
    return 0
