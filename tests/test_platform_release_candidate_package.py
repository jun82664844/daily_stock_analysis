...
class PlatformReleaseCandidatePackageVerifierTestCase(unittest.TestCase):
    ...
    def test_v136_observed_event_reactions_are_part_of_release_package(self) -> None:
        ...
        self.assertIn("src/services/public_market_event_reaction_service.py", REQUIRED_FILES)
        self.assertIn("tests/test_public_market_event_reaction_service_v136.py", REQUIRED_FILES)
        self.assertIn("tests/test_public_market_event_reaction_api_v136.py", REQUIRED_FILES)
        self.assertIn("api/middlewares/auth.py", REQUIRED_FILES)
        self.assertIn("api/v1/endpoints/market_workspace.py", REQUIRED_FILES)
        self.assertIn("apps/dsa-web/src/components/market-home/MarketEventReactionPanelV136.tsx", REQUIRED_FILES)
        self.assertIn("apps/dsa-web/src/components/market-home/__tests__/MarketEventReactionPanelV136.test.tsx", REQUIRED_FILES)
        self.assertIn("scripts/verify_platform_observed_event_reactions_v136.py", REQUIRED_FILES)
        self.assertIn("scripts/verify_platform_observed_event_reactions_v136.py", VERIFIER_FILES)
        self.assertIn("tests/test_platform_observed_event_reactions_v136_verifier.py", REQUIRED_FILES)
        self.assertIn("docs/superpowers/plans/2026-07-30-dsa-v136-observed-event-market-reactions.md", REQUIRED_FILES)
    ...
    def test_v131_returning_event_inbox_is_part_of_release_package(self) -> None:
        ...
        self.assertIn("scripts/verify_platform_returning_event_inbox_v131.py", REQUIRED_FILES)
        self.assertIn("scripts/verify_platform_returning_event_inbox_v131.py", VERIFIER_FILES)
        self.assertIn("tests/test_platform_returning_event_inbox_v131_verifier.py", REQUIRED_FILES)
        self.assertIn(
    ...
    def test_v130_personalized_market_events_are_part_of_release_package(self) -> None:
        from scripts.verify_platform_release_candidate_package import REQUIRED_FILES, VERIFIER_FILES

        self.assertIn("scripts/verify_platform_personalized_market_events_v130.py", REQUIRED_FILES)
        self.assertIn("scripts/verify_platform_personalized_market_events_v130.py", VERIFIER_FILES)
        self.assertIn("tests/test_platform_personalized_market_events_v130_verifier.py", REQUIRED_FILES)
        self.assertIn(
    ...
    def test_v127_market_event_relevance_is_part_of_release_package(self) -> None:
        ...
        self.assertIn("scripts/verify_platform_market_event_relevance_v127.py", REQUIRED_FILES)
        self.assertIn("scripts/verify_platform_market_event_relevance_v127.py", VERIFIER_FILES)
        self.assertIn("tests/test_platform_market_event_relevance_v127_verifier.py", REQUIRED_FILES)
        self.assertIn("docs/superpowers/plans/2026-07-15-dsa-v127-market-event-relevance.md", REQUIRED_FILES)

    def test_v126_free_daily_market_events_are_part_of_release_package(self) -> None:
        from scripts.verify_platform_release_candidate_package import REQUIRED_FILES, VERIFIER_FILES

        self.assertIn("scripts/verify_platform_free_daily_market_events_v126.py", REQUIRED_FILES)
        self.assertIn("scripts/verify_platform_free_daily_market_events_v126.py", VERIFIER_FILES)
        self.assertIn("tests/test_platform_free_daily_market_events_v126_verifier.py", REQUIRED_FILES)
        self.assertIn("tests/test_public_market_event_service.py", REQUIRED_FILES)
        self.assertIn("src/services/public_market_event_service.py", REQUIRED_FILES)
        self.assertIn("apps/dsa-web/src/components/market-home/DailyMarketEventCenterV126.tsx", REQUIRED_FILES)
        self.assertIn("docs/superpowers/plans/2026-07-14-dsa-v126-free-daily-market-events.md", REQUIRED_FILES)

    def test_v125_market_sessions_and_home_performance_are_part_of_release_package(self) -> None:
        from scripts.verify_platform_release_candidate_package import REQUIRED_FILES, VERIFIER_FILES

        self.assertIn("scripts/verify_platform_market_sessions_home_performance_v125.py", REQUIRED_FILES)
        self.assertIn("scripts/verify_platform_market_sessions_home_performance_v125.py", VERIFIER_FILES)
        self.assertIn("tests/test_platform_market_sessions_home_performance_v125_verifier.py", REQUIRED_FILES)
        self.assertIn("tests/test_public_market_session_service.py", REQUIRED_FILES)
        self.assertIn("src/services/public_market_session_service.py", REQUIRED_FILES)
        self.assertIn("docs/superpowers/plans/2026-07-14-dsa-v125-market-session-home-performance.md", REQUIRED_FILES)
    ...
    def test_v122_support_notifications_are_part_of_release_package(self) -> None:
        ...
        self.assertIn("scripts/verify_platform_support_notifications_v122.py", REQUIRED_FILES)
        self.assertIn("scripts/verify_platform_support_notifications_v122.py", VERIFIER_FILES)
        self.assertIn("tests/test_platform_support_notifications_v122_verifier.py", REQUIRED_FILES)
        self.assertIn("tests/test_platform_support_notifications_api_v122.py", REQUIRED_FILES)
        self.assertIn("apps/dsa-web/e2e/platform-support-notifications-v122.spec.ts", REQUIRED_FILES)
        self.assertIn("docs/superpowers/plans/2026-07-14-dsa-v122-support-inbox-notifications.md", REQUIRED_FILES)

    def test_v121_free_market_stock_preview_is_part_of_release_package(self) -> None:
        from scripts.verify_platform_release_candidate_package import REQUIRED_FILES, VERIFIER_FILES

        self.assertIn("scripts/verify_platform_free_market_stock_preview_v121.py", REQUIRED_FILES)
        self.assertIn("scripts/verify_platform_free_market_stock_preview_v121.py", VERIFIER_FILES)
        self.assertIn("tests/test_platform_free_market_stock_preview_v121_verifier.py", REQUIRED_FILES)
        self.assertIn("apps/dsa-web/src/components/market-home/PublicMarketStockPreviewV121.tsx", REQUIRED_FILES)
        self.assertIn("apps/dsa-web/src/components/market-home/__tests__/PublicMarketStockPreviewV121.test.tsx", REQUIRED_FILES)
        self.assertIn("docs/superpowers/plans/2026-07-14-dsa-v121-free-market-stock-preview.md", REQUIRED_FILES)

    def test_v120_support_center_is_part_of_release_package(self) -> None:
        from scripts.verify_platform_release_candidate_package import REQUIRED_FILES, VERIFIER_FILES

        self.assertIn("scripts/verify_platform_support_center_v120.py", REQUIRED_FILES)
        self.assertIn("scripts/verify_platform_support_center_v120.py", VERIFIER_FILES)
        self.assertIn("tests/test_platform_support_center_v120_verifier.py", REQUIRED_FILES)
        self.assertIn("tests/test_platform_support_api_v120.py", REQUIRED_FILES)
        self.assertIn("src/services/platform_support_service.py", REQUIRED_FILES)
        self.assertIn("apps/dsa-web/src/pages/SupportPage.tsx", REQUIRED_FILES)
        self.assertIn("apps/dsa-web/src/components/admin/SupportWorkbenchV120.tsx", REQUIRED_FILES)
        self.assertIn("docs/superpowers/plans/2026-07-14-dsa-v120-platform-support-center.md", REQUIRED_FILES)
